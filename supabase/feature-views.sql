...
values
  ('caramel-founder-story', '대학생 때 시작해 6개월 만에 1만 사용자를 만든 팀', 'interview', '작은 팀의 기록을 다음 실행으로 바꾸는 카라멜랩의 이야기', '[]', 'published', '2026-08-12T00:00:00+09:00', 11204),
  ...
  ('first-100-users', '광고비 0원으로 첫 100명의 팬을 만든 과정', 'qna', '초기 창업가가 커뮤니티에서 진짜 사용자를 만나는 법', '[]', 'published', '2026-08-16T00:00:00+09:00', 14386),
