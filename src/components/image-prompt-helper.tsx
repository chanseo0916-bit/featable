...
const STYLE_SUFFIX =
  "\n\n스타일: 실제 카메라로 촬영한 사진처럼 만들 것 (3D 렌더링, CG, 일러스트, 목업 이미지는 절대 금지). 배경은 예외 없이 순백색(#FFFFFF) 스튜디오 배경이며 그라데이션이나 어두운 배경은 금지. 미니멀한 한국 스타트업 브랜드 상세페이지 사진, 포인트 컬러는 오렌지(#EF4125) 하나만 사용. 깔끔한 여백, 부드러운 자연광, 과장 없는 사실적인 연출. 이미지 안에 글자·로고·워터마크는 넣지 말 것.";
  ...
  return [
    {
      ...
      title: "① 대표 이미지",
      ratio: "16:9",
      body: `${name}의 대표 컷. ${tagline ? `${tagline}. ` : ""}흰색 스튜디오 배경 중앙에 제품을 상징하는 오브제를 하나만 배치 (소프트웨어·서비스라면 노트북이나 태블릿 외형 하나만 놓고, 화면은 꺼져 있거나 흐릿하게 처리 — 화면 속 UI·인터페이스를 새로 그려내지 말 것. 실제 화면은 앱 스크린샷을 별도로 캡처해 폰 프레임 이미지 블록에 올리는 걸 권장), 오렌지색 소품 하나로 포인트. 45도 위에서 내려다보는 앵글, 부드러운 그림자.${STYLE_SUFFIX}`,
    },
    {
      key: "intro",
      title: "② 인트로 무드컷",
      ...
      {open && (
        <div className="border-t border-border px-5 pb-5">
          ...
          <p className="pb-1 text-xs leading-relaxed text-muted">
            💡 <b>앱·웹서비스 화면은 AI로 만들지 마세요.</b> 실제 스크린샷을 캡처해서
            이미지 블록의 <b>&ldquo;폰 프레임&rdquo;</b> 옵션으로 올리면 훨씬 자연스럽습니다.
            아래 프롬프트는 인물·브랜드 무드컷처럼 실물 촬영이 필요한 장면에만 쓰세요.
          </p>
