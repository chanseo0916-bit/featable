  ...
  return [
    {
      ...
      title: "① 대표 이미지",
      ratio: "16:9",
      body: `${name}의 대표 컷. ${tagline ? `${tagline}. ` : ""}흰색 스튜디오 배경 중앙에 제품을 하나만 배치 (소프트웨어·서비스라면, 실제 노트북이나 모니터를 그 화면에 인터페이스가 떠 있는 상태로 촬영한 사진처럼 — 3D로 띄워진 화면이나 렌더링된 기기 목업은 금지), 오렌지색 소품 하나로 포인트. 45도 위에서 내려다보는 앵글, 부드러운 그림자.${STYLE_SUFFIX}`,
    },
    {
      key: "intro",
      title: "② 인트로 무드컷",
