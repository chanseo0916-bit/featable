...
export function Header() {
  return <header className="site-header"><div className="shell nav-wrap"><Link className="logo" href="/"><FeatableLogo priority /></Link><nav className="desktop-nav"><Link href="/stories">피쳐</Link><Link href="/products">프로덕트</Link><Link href="/events">이벤트</Link><Link href="/support">기회</Link><details><summary>더보기 <span>⌄</span></summary><div className="more-menu"><Link href="/brands">브랜드</Link><Link href="/communities">커뮤니티</Link><Link href="/jobs">채용</Link></div></details></nav><div className="nav-actions"><Link className="search-link" href="/search">⌕<span className="sr-only">검색</span></Link><Link className="login-link" href="/login">로그인</Link><Link className="button button-small nav-submit" href="/submit">브랜드 올리기 <span>↗</span></Link></div></div></header>;
}
