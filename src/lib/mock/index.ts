...
export const products: Product[] = [
  {
    slug: "caramel-note",
    name: "카라멜 노트",
    heroUrl: image("product-caramel", 1200, 900),
    images: [image("caramel-detail-1", 900, 1100), image("caramel-detail-2", 900, 1100)],
    brandSlug: "caramel-lab",
    founderSlug: "minseo-kim",
    tagline: "팀의 모든 생각을 한 번에 연결하는 AI 노트",
    story: [
      { type: "text", heading: "좋은 아이디어는 왜 회의실에서 사라질까요?", body: "회의가 끝나면 기록은 문서에 남지만, 그 안에 있던 맥락과 다음 행동은 금세 흩어집니다. 카라멜 노트는 기록을 보관하는 데서 멈추지 않고 팀의 실행으로 이어지게 합니다." },
      { type: "image", src: image("caramel-long-problem", 1000, 1250), alt: "여러 도구에 흩어진 팀의 기록" },
      { type: "text", heading: "기록하는 순간, 다음 일이 정리됩니다", body: "회의를 시작하면 카라멜 노트가 대화를 이해하고 핵심 결정, 담당자, 마감일을 한 화면에 정리합니다. 팀원은 정리에 쓰던 시간을 다시 만드는 일에 사용할 수 있습니다." },
      { type: "image", src: image("caramel-long-solution", 1000, 1280), alt: "카라멜 노트로 정리된 업무 화면", caption: "대화에서 액션까지 한 번에 연결합니다." },
      { type: "text", heading: "01. 회의가 끝나기 전에 완성되는 요약", body: "누가 어떤 이야기를 했는지, 무엇을 결정했는지 자동으로 구분합니다. 팀이 합의한 내용만 빠르게 확인하고 바로 공유하세요." },
      { type: "image", src: image("caramel-long-summary", 1000, 1180), alt: "AI 회의 요약 기능" },
      { type: "text", heading: "02. 흩어진 정보가 하나의 맥락으로", body: "문서, 링크, 지난 회의가 프로젝트별로 자연스럽게 연결됩니다. 검색어가 정확히 기억나지 않아도 필요한 배경을 다시 찾을 수 있습니다." },
      { type: "image", src: image("caramel-long-connect", 1000, 1260), alt: "프로젝트 지식 연결 기능" },
      { type: "text", heading: "03. 말한 일이 진짜 다음 행동으로", body: "대화 속 할 일을 자동으로 찾아 담당자와 일정에 연결합니다. 회의록을 다시 읽으며 할 일을 옮겨 적지 않아도 됩니다." },
      { type: "image", src: image("caramel-long-action", 1000, 1220), alt: "팀 액션 자동 추출 기능" },
      { type: "text", heading: "작은 팀이 더 빠르게 움직일 수 있도록", body: "카라멜랩은 기능이 많은 도구보다 매일 자연스럽게 열게 되는 도구를 만들고 있습니다. 팀의 좋은 생각이 사라지지 않고 실제 변화가 되는 순간까지 함께하겠습니다." },
      { type: "image", src: image("caramel-long-team", 1000, 1280), alt: "카라멜랩 팀과 제품을 사용하는 사람들", caption: "생각을 기록하는 순간부터 팀의 일이 시작됩니다." },
    ],
    problem: "회의록, 링크, 할 일이 여러 도구에 흩어져 다시 찾기 어렵습니다.",
    solution: "대화와 자료를 자동으로 정리하고 다음 액션까지 연결합니다.",
    features: ["AI 회의 요약", "프로젝트별 지식 연결", "팀 액션 자동 추출"],
    category: "AI",
    price: "월 9,900원",
    officialUrl: "https://example.com",
    viewCount: 1280,
    mentorNote: { mentorName: "김OO", mentorField: "Marketing", comment: "첫 메시지가 명확하고, 작은 팀을 위한 제품의 장점이 잘 보입니다." },
    relatedFeatureSlugs: ["caramel-founder-story"],
  },
...
export const features: Feature[] = [
  { slug: "caramel-founder-story", title: "대학생 때 시작해 6개월 만에 1만 사용자를 만든 팀", coverUrl: image("feature-caramel", 1400, 900), kind: "interview", excerpt: "작은 팀의 기록을 다음 실행으로 바꾸는 카라멜랩의 이야기", body: [{ type: "text", heading: "기록이 실행이 되기까지", body: "카라멜랩은 팀의 대화 속에 있는 가능성을 놓치지 않기 위해 시작했습니다." }], brandSlug: "caramel-lab", founderSlug: "minseo-kim", publishedAt: "2026-08-12", viewCount: 11204 },
  ...
  { slug: "first-100-users", title: "광고비 0원으로 첫 100명의 팬을 만든 과정", coverUrl: image("feature-first-fans", 1400, 900), kind: "qna", excerpt: "초기 창업가가 커뮤니티에서 진짜 사용자를 만나는 법", body: [{ type: "text", heading: "고객보다 먼저 팬을 만났습니다", body: "제품을 설명하기 전에 왜 만들었는지 이야기하자 사람들이 반응하기 시작했습니다." }], brandSlug: "caramel-lab", founderSlug: "minseo-kim", publishedAt: "2026-08-16", viewCount: 14386 },
