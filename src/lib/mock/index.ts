...
export const brands: Brand[] = [
  { slug: "caramel-lab", name: "카라멜랩", logoUrl: image("logo-caramel", 160, 160), coverUrl: image("cover-caramel"), tagline: "생각을 정리하면, 일이 빨라집니다.", description: "팀의 아이디어와 업무를 한 곳에서 정리하는 AI 노트 SaaS입니다.", problem: "회의와 자료가 여러 곳에 흩어져 중요한 생각이 사라집니다.", audience: "빠르게 움직이는 작은 팀", category: "AI", founderSlug: "minseo-kim", foundedAt: "2025-03", productSlugs: ["caramel-note"], featureSlugs: [] },
