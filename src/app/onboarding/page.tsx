    ...
    <main className="min-h-screen bg-[#f6f6f4] px-5 py-10 sm:py-16">
      <div className="mx-auto grid max-w-5xl overflow-hidden rounded-[28px] border border-border bg-white lg:grid-cols-[0.82fr_1.18fr]">
        <aside className="flex flex-col justify-between bg-[#111] p-8 text-white sm:p-11">
          ...
          <div className="my-16">
            <p className="mb-4 text-xs font-bold tracking-[0.18em] text-[#ff765f]">마지막 단계</p>
            <h1 className="text-4xl font-bold leading-[1.15] tracking-[-0.055em]">발견될 준비를<br />마쳐볼까요?</h1>
        ...
        <section className="p-7 sm:p-11 lg:p-14">
          <p className="text-xs font-bold tracking-[0.16em] text-accent">환영합니다</p>
          <h2 className="mt-3 text-3xl font-bold tracking-[-0.045em]">가입 정보를 확인해주세요</h2>
