...
export default async function ProductSubmitPage({ searchParams }: { searchParams: Promise<{ brand?: string }> }) {
  ...
  return <>
    ...
    <main className="simple-registration-page product-registration-page"><div className="shell"><ProductRegistrationForm brands={brands} initialBrandId={initialBrandId} /></div></main>
  </>;
}
