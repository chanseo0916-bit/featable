...
export default async function SubmitPage() {
  ...
  return (
    <>
      <div className="publish-console-nav"><div className="shell"><StudioBrand /><nav><a className="active" href="#editor">브랜드 관리</a><a href="#products">프로덕트</a><a href="#story">상세페이지</a><a href="#publish">공개 설정</a></nav><Link href="/my">내 워크스페이스 →</Link></div></div>
