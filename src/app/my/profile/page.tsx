  ...
  return <>
    ...
    <main className="dash-page dash-settings">
      <div className="shell dash-settings-inner profile-settings-inner">
        <header><span>PROFILE CARD</span><h1>{interviewSetup ? "인터뷰를 내 프로필과 먼저 연결할게요." : "내 프로필 카드"}</h1><p>{interviewSetup ? "프로필은 인터뷰에 내 정보를 표시하고, 이후 내가 직접 수정할 수 있도록 확인하는 데 사용됩니다. 한 번만 등록하면 다음부터는 바로 인터뷰를 작성할 수 있으며 가입 역할과 팀 권한은 바뀌지 않습니다." : "현재 역할과 만드는 사람으로서의 이야기를 소개해주세요. 브랜드가 없어도 만들 수 있어요."}</p></header>
